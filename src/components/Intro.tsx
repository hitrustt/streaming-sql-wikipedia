  ...
  return (
    <div className="intro">
      ...
      <span className="intro__text">
        ...
        second</b>, queried entirely in your browser. Views default to <b>people editing Wikipedia
        articles</b>, since most of the raw firehose is bots updating database records.{' '}
        <b>Click a question on the left</b> to run a live query, or edit the SQL yourself and hit Run.
      </span>
